...
*Testmember Resource Properties* 
| Name | Type | Required | Default | Definition | 
| ---- | ---- | -------- | ------- | ---------- |
| **userId** | ID |  |  | ** |
| **objectId** | ID |  |  | ** |
...
*Default access route* : *GET* `/tests/:testId`
...
```json
{"status":"OK","statusCode":"200","elapsedMs":126,"ssoTime":120,"source":"db","cacheKey":"hexCode","userId":"ID","sessionId":"ID","requestId":"ID","dataName":"test","action":"get","appVersion":"Version","rowCount":1,"test":{"id":"ID","isActive":true}}
```  
...
*Default access route* : *GET* `/usertests/:testId`
